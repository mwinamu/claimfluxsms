    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <table class="table table-hoverd table-bordered" id="awaitingDispatch"></table>
                </div>
            </div>
            <div class="card mb-3"id="datatableRow">
                ...
                <div class="card-body">
                    <table class="table table-hoverd table-bordered" id="awaitingDispatchMessages"></table>
                </div>
            </div>
        </div>
    </div>
